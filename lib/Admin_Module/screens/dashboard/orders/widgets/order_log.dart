...
class AdminOrderLogScreen extends StatefulWidget {
  final ApprovedOrders order;

  AdminOrderLogScreen({required this.order});

  @override
  State<AdminOrderLogScreen> createState() => _AdminOrderLogScreenState();
}

class _AdminOrderLogScreenState extends State<AdminOrderLogScreen> {
  List<int> statusList=[];
  getOrderLog() async {
