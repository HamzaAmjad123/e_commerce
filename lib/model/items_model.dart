...
class Items {
  ...
  Items({this.itemId, this.name, this.slogan, this.code, this.unitPrice, this.unitDiscountPercentage, this.status, this.availableStock, this.isApproved, this.approvedBy, this.image, this.address, this.cityId, this.rankId, this.rank, this.languageId, this.language, this.classId, this.classModel, this.seriesId, this.series, this.itemTypeId, this.itemType, this.warehouseId, this.warehouse, this.tenantId, this.createdBy, this.createdDate, this.updatedBy, this.updatedDate});
  ...
  classModel = json['classModel'] != null ? new ClassModel.fromJson(json['classModel']) : null;
