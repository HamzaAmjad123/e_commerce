class StockListModel {
  ...
  StockListModel({this.totalCount, this.result});

  StockListModel.fromJson(Map<String, dynamic> json) {
    totalCount = json['totalCount'];
    if (json['result'] != null) {
      result = <StockList>[];
      json['result'].forEach((v) { result!.add(new StockList.fromJson(v)); });
    }
  }
...
class StockList {
  ...
  StockList({this.itemId, this.name, this.seriesId, this.series, this.unitDiscountPercentage, this.unitPrice, this.slogan, this.code, this.availableStock, this.isApproved, this.approvedBy, this.image, this.address, this.cityId, this.rankId, this.rank, this.status, this.languageId, this.classId, this.A, this.itemTypeId, this.itemType, this.warehouseId, this.warehouse, this.tenantId, this.rankingColor});
  ...
  A = json['class'] != null ? new Class.fromJson(json['class']) : null;
